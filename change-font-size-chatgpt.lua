...
function adjust_font_size(subtitles, selected_lines, delta)
    for _, line_index in ipairs(selected_lines) do
        ...
        if fs_tag then
            ...
            local new_font_size = current_font_size + delta
...
aegisub.register_macro("Adjust Font Size", "Adjusts the font size of selected lines", main)
